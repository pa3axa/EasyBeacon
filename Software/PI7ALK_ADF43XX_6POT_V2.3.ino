...
----------------------------------------------------------------
 ...
 Frequency DATA for 3400.925 mhz PI7ALK
  ...
  PI4 Tone | Caculated Frequncy    | Potmer to adj   
----------------------------------------------------------------
 ...
 V2.1 Fixed CW routine to maintain CW Space between characters.  

 V2.2 Fixed missing delay in PI4 routine.

 V2.3 Fixed missing clear in PI4 routine.
